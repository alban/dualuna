export const QUESTS = {
  'tremors-in-the-deep': {
    ...
    objectives: [
      { id: 'talk-kael', description: 'Talk to Foreman Kael about the tremors' },
      { id: 'examine-shaft', description: 'Examine the damage in the mine shaft' },
      { id: 'consult-tink', description: 'Consult Tink the engineer on Spark Cove' },
  ...
  'the-deep-response': {
    ...
    objectives: [
      { id: 'return-to-kael', description: 'Report findings to Foreman Kael' },
