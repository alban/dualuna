...
const PROMPTS = {
  ...
  'museum': `${STYLE} Interior of a small museum built into a clifftop building. Stone floors, warm lantern light from wall-mounted sconces. One wall has a large framed astronomical chart showing two moons in dozens of positions. The ceiling has panels of amber-colored cut crystal arranged in a precise grid, casting warm amber light. A mythology section in the corner has framed stone panels with inscriptions. A cracked exhibit sign is visible near the center. The room has an unusual stillness, as if it remembers being something else.`,

  'sleep-temple': `${STYLE} Interior of a communal sleep temple carved from pale stone. Many small circular stone beds arranged in a spiral pattern across the floor. The floor has faint carved lines connecting the bed positions like a lattice. The ceiling is set with amber crystal panels that emit warm amber-red light — soft, calming. No windows. The air has a quality of suspension, of time slowing. The room feels much older than the stone, and perfectly quiet.`,
